"""
Initialization script for Docker deployment.
This script initializes the RAG system with sample data when running in Docker.
"""
...
def initialize_rag_system():
    """Initialize the RAG system with sample data for Docker deployment."""
    ...
    index_file = os.path.join(indexes_dir, "faiss.index")
